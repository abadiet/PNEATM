...
pneatm::Population<myInt, myFloat> SetupPopulation (unsigned int popSize, spdlog::logger* logger) {
    ...
    return pneatm::Population<myInt, myFloat> (popSize, bias_sch, inputs_sch, outputs_sch, hiddens_sch_init, bias_init, resetValues, activationFns, N_ConnInit, probRecuInit, weightExtremumInit, maxRecuInit, logger, speciationThreshInit, threshGensSinceImproved, "stats16.csv");
}
