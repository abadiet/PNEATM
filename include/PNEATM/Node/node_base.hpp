...
class NodeBase{
    public:
		 ...
		 */
		virtual void reset (bool resetMemory = true, bool resetBuffer = false, bool resetInput = true) = 0;
		 ...
		 */
		virtual void deserialize (std::ifstream& inFile, ActivationFnBase* activationFn) = 0;
